...
namespace SAS.Forms
{
...

    {
        ...
        private void InitCombox()
        {
            ...
            for (int i = 0; i < frmMain.FormList.Items.Count; i++)
            {
                //comboBox2.Items.Add(DtName.Rows[i][0].ToString());
                comboBox2.Items.Add(frmMain.FormList.Items[i].SubItems[3].Text);
            }
        }
       ...
       //  EndTime2 = EndTime + 86400;
            // SelectCommand = string.Format("select * from Logs_Data where CTime<{1} and CTime>{0}", EndTime,StartTime);
            SelectCommand = string.Format("select * from Logs_Data where CTime>{0} and CTime<{1}", StartTime, EndTime);
            if (comboBox2.Text == "全部" || comboBox2.Text == "")
            {
                name = "";
            ...
            if (comboBox1.Text == "全部" || comboBox1.Text == "")
            {
                type = "";
