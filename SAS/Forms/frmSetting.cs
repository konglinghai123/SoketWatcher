...
{   
    public partial class frmSetting : Form
    {
        ...
        private void Insert2DataBase()
        {
          ...
          {
              MessageBox.Show("请检测是否有重复输入主机地址", "系统提示!");
        ...
        {    
            ...
            {
                MessageBox.Show("请检查是否存在该地址", "系统提示!");
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请检测是否有重复输入主机地址" + ex.ToString(), "系统提示!");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (openFile.ShowDialog() == DialogResult.OK)
                {
                   ...
                   con.Close();
                   MessageBox.Show("导入成功,如果没有数据，请检查IP是否符合格式", "系统提示!");
                   ListViewShow();
                   frmMain.fm.ListViewShow();
        ...
        private void frmSetting_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                //Client ClisX = new Client();
                frmMain.fm.GengXinSohw();
              //  ClisX.CloseThread();
